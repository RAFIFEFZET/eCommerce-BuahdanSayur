                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    @foreach([$data->image1_url, $data->image2_url, $data->image3_url, $data->image4_url, $data->image5_url] as $image)
                                                        @if($image)
                                                            <img src="{{ asset($image) }}" class="img-thumbnail" style="max-width: 100px; margin-right: 5px; cursor: pointer;" data-bs-toggle="modal" data-bs-target="#imageModal{{ $loop->index }}">
                                                            <!-- Modal -->
