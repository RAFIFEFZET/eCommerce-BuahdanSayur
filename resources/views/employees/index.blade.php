            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <a href="{{ route('employees.create') }}"><span
                                class="badge badge-sm bg-gradient-primary mb-3 fs-6">Add new Employee Account</span></a>
                        <h6>Employees</h6>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('employees.edit', $data->id) }}" class="badge badge-sm bg-gradient-success me-2">Edit</a>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end mb-0">
                                <li class="page-item {{ $employees->onFirstPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $employees->previousPageUrl() }}" tabindex="-1" {{ $employees->onFirstPage() ? 'aria-disabled=true' : '' }}>
                                ...
                                @for ($page = 1; $page <= $employees->lastPage(); $page++)
                                    <li class="page-item {{ $page == $employees->currentPage() ? 'active' : '' }}" aria-current="page">
                                        <a style="color: #344767" class="page-link" href="{{ $employees->url($page) }}">{{ $page }}</a>
                                    </li>
                                @endfor
