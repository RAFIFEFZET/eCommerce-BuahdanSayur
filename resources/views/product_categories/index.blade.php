            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <a href="{{ route('product_categories.create') }}"><span
                                class="badge badge-sm bg-gradient-primary mb-3 fs-6">Add new Product Categories</span></a>
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($product_categories as $idx => $data)
                                        <tr>
                                            <td>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('product_categories.edit', $data->id) }}" class="badge badge-sm bg-gradient-success me-2">Edit</a>
                    ...
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end mb-0">
                                <li class="page-item {{ $product_categories->onFirstPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $product_categories->previousPageUrl() }}" tabindex="-1" {{ $product_categories->onFirstPage() ? 'aria-disabled=true' : '' }}>
                                        <i class="fa fa-angle-left"></i>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                </li>
                                @for ($page = 1; $page <= $product_categories->lastPage(); $page++)
                                    <li class="page-item {{ $page == $product_categories->currentPage() ? 'active' : '' }}" aria-current="page">
                                        <a style="color: #344767" class="page-link" href="{{ $product_categories->url($page) }}">{{ $page }}</a>
                                    </li>
                                @endfor
                                <li class="page-item {{ !$product_categories->hasMorePages() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $product_categories->nextPageUrl() }}">
